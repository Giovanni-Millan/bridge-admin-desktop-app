...
export default function ConsultarGrupos() {
  ...
  const carreras = [
    { id: 1, nombre: 'Ingeniería en Sistemas', ruta: '/ModificarGrupoSistemas', icono: faLaptopCode },
    { id: 2, nombre: 'Derecho', ruta: '/ModificarGrupoDerecho', icono: faGavel },
    { id: 3, nombre: 'Pedagogía', ruta: '/ModificarGrupoPedagogia', icono: faChalkboardTeacher },
    { id: 4, nombre: 'Psicología', ruta: '/ModificarGrupoPsicologia', icono: faBrain },
    { id: 5, nombre: 'Administración', ruta: '/ModificarGrupoAdministracion', icono: faMoneyBillTrendUp },
  ];

  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100">
      <Navbar titulo="Modificar Usuarios" />
